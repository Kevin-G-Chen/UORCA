...
RUN apt-get update
RUN apt-get install -y curl build-essential nodejs npm libcurl4-openssl-dev libssl-dev libxml2-dev libfontconfig1-dev libfreetype6-dev libfribidi-dev libharfbuzz-dev libtiff-dev libjpeg-dev libpng-dev libtiff-dev libgit2-dev libzmq3-dev
