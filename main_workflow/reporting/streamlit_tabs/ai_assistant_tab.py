...
def _display_unified_ai_results(
    ...
    with gene_tab:
        ...
        gene_download_key = f"download_genes_tab1_{_generate_analysis_id(research_question, selected_contrast_dicts)}"
    ...
    with table_tab:
        ...
        if rows:
            ...
            expression_download_key = f"download_expression_tab3_{_generate_analysis_id(research_question, selected_contrast_dicts)}"
    ...
    with contrast_tab:
        ...
        if selected_contrasts and hasattr(selected_contrasts[0], 'selection_justification'):
            if selected_data:
                ...
                contrast_download_key = f"download_contrasts_selected_tab4_{_generate_analysis_id(research_question, selected_contrast_dicts)}"
            ...
            if contrast_display_data:
                ...
                contrast_download_key = f"download_contrasts_analysed_tab4_{_generate_analysis_id(research_question, selected_contrast_dicts)}"
...
"""
            ...
            report_download_key = f"download_report_tab6_{_generate_analysis_id(research_question, selected_contrast_dicts)}"
            ...
            try:
                ...
                if not filtered_df.empty:
                    ...
                    agent_data_key = f"download_agent_data_tab6_{_generate_analysis_id(research_question, selected_contrast_dicts)}"
        ...
        with col2:
            ...
            if not results_df.empty:
                ...
                relevance_key = f"download_all_relevance_tab6_{_generate_analysis_id(research_question, selected_contrast_dicts)}"
            ...
            if tool_calls:
                ...
                raw_log_key = f"download_raw_log_tab6_{_generate_analysis_id(research_question, selected_contrast_dicts)}"
